...
import { 
  ...
  ShieldCheck, ArrowLeft, RefreshCw, Search
} from "lucide-react";
...
const TelegramManagement = () => {
  ...
  const handleToggleBot = async (enabled: boolean) => {
    try {
      ...
      toast({
        variant: "destructive",
        title: "خطأ",
        description: "فشل تحديث حالة البوت",
      });
    }
  };
  ...
  const handleSendBroadcast = async () => {
    ...
    // In a real implementation, this would trigger a background job or a Supabase function
    // For now, we'll simulate success
    setTimeout(() => {
      toast({
        title: "تم الإرسال",
        description: `تم إرسال الرسالة إلى ${users.length} مشترك`,
      });
      setBroadcastMsg("");
    }, 2000);
  };
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-end">
                  <Button onClick={handleSendBroadcast} disabled={!broadcastMsg.trim()}>
                        ...
                        <div className={`max-w-[80%] p-3 rounded-lg ${
                          ...
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-[10px] font-bold opacity-70">
                              {msg.role === 'user' ? (msg.telegram_users?.first_name || "مستخدم") : "البوت"}
                            </span>
